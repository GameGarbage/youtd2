# How to create a water map

I'll help you create this Godot scene file step by step. This appears to be a water-themed map scene. Here's how to build it:

First, create a new scene with a root Node2D named "WaterMap":
...
Insert at cursor
gdscript
Add a TileMap node as a child of WaterMap:
...
- Create 3 layers:
  - Layer 0: named "water"
  - Layer 1: named "decorations" (y_sort enabled)
  - Layer 2: named "borders" (y_sort enabled)

Copy

Insert at cursor
gdscript
Add WaterParticles node:

WaterParticles:
- Set amount to 100
- Create a ParticleProcessMaterial with:
  - disable_z = true
  - emission_shape = box
  - emission_box_extents = (800, 600, 1)
  - gravity = (0, 0, 0)
  - scale_min = 0.5
  - scale_max = 1.5
...
- Create Environment resource with:
  ...
  - ambient_light_color = Color(0.611765, 0.811765, 1, 1)
  - ambient_light_energy = 0.5
  - Enable glow
  - Set glow_bloom = 0.2
  - Set glow_blend_mode = 0

Copy

Insert at cursor
gdscript
Add AmbientLight (DirectionalLight2D):

AmbientLight:
- Set color = Color(0.611765, 0.811765, 1, 1)
- Set energy = 0.5
- Set blend_mode = 1
